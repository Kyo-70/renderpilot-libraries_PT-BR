...
const SCHEMAS = Object.freeze({
  ...
  renodxManifestV2: "catalogs/addons/renodx/manifest-v2.schema.json",
  renodxCurationLedger: "catalogs/addons/renodx/curation-ledger.schema.json",
  renodxWikiMessages: "catalogs/addons/renodx/wiki-messages.schema.json",
...
export const jsonDocuments = defineDocuments([
  ...
  {
    file: "addons/v2/renodx.json",
    schema: SCHEMAS.renodxManifestV2,
    r2Key: "addons/v2/renodx.json",
    publishedToR2: true,
  },
  {
    file: "catalogs/addons/renodx/review-ledger.json",
    schema: SCHEMAS.renodxCurationLedger,
    publishedToR2: false,
  },
  {
    file: "catalogs/addons/renodx/wiki_messages.json",
    schema: SCHEMAS.renodxWikiMessages,
    publishedToR2: false,
  },
  {
    file: "catalogs/addons/renodx/wiki_source.json",
    schema: SCHEMAS.renodxWikiSource,
    publishedToR2: false,
  },
  {
    file: "catalogs/addons/renodx/messages.json",
    schema: SCHEMAS.renodxMessagesSource,
    publishedToR2: false,
  },
  {
...
export const addonCatalogs = Object.freeze({
  ...
  renodx: addonCatalog(
    "renodx",
    {
      ...
      wikiMessages: "wiki_messages.json",
      wikiSource: "wiki_source.json",
      reviewLedger: "review-ledger.json",
      curatedGames: "curated_games.json",
      messages: "messages.json",
    ...
    },
    {
      ...
      manifestV2: "addons/v2/renodx.json",
    },
  ),

// Tool-neutral typed Engine.ini authoring.
//
// Recipes are the mutation contract. Their displayed code is always rendered
// from the normalized structure, so a catalog cannot silently publish prose
// that differs from what the runtime will apply.
...
/** Normalizes and validates a closed typed Engine.ini recipe. */
...
/** Defines an immutable reviewed recipe. */
